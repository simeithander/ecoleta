...
const CreatePoint: React.FC = () => {
  ...
  //Inicia uma única vez ao dar load na página
  useEffect(() => {
  ...
  //Carregar a cidade após selecionar a UF
  useEffect(() => {
  ...
  function handleInputChange(event: ChangeEvent<HTMLInputElement>){
    ...
    //... copia o estado anterior de formData e modifica apenas o campo selecionado
